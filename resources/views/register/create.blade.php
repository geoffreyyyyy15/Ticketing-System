<x-layout>
    <div class="flex justify-center items-center h-screen py-2 my-2">
        <div class="flex justify-center md:mb-0 bg-gray-100 shadow-xl shadow-gray-900 w-[400px] p-2 m-2 rounded-lg">
            <form action="#" class="">
