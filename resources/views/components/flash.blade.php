...
<div x-data="{show: true }" x-init="setTimeout(() => show = false, 5000)" x-transition x-show="show">
    <div id="alert-border-3" class="flex p-4 mb-4 rounded-lg text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800" role="alert">
